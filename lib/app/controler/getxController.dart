...
class Get_xController extends GetxController{
  ...
  void _videoLoad()async{
    YoutubeVideoResult youtubeVideoResult =await YoutubeRepository.to.loadgetxvideo(ytresult.value.nextPageToken ?? "");
